        ...
        <?php if ($isAuthed): ?>
            ...
            <li class="nav-item has-submenu">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="/fit/kalorien_data"><img src="/img/burger.png" alt="Kalorien" class="nav-icon" loading="eager" decoding="sync" fetchpriority="high"><span class="submenu-text">Kalorien-Daten</span></a></li>
